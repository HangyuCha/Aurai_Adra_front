const steps = [
  ...
  { id: 3, title: '저장 확인', instruction: '저장된 연락처를 확인하고 목록에 나타나는지 확인하세요.', focusAreas:[{x:6,y:48,w:88,h:10,pill:true}], forceKeyboard: true, speak: '저장을 마쳤어요. 필요하다면 키보드로 짧게 메모를 입력해 보세요.', completionSpeak: '잘하셨어요 아래 완료 버튼을 눌러 더 많은걸 배우러 가볼까요?' }
];

...
export default function SmsMphotoLesson(){
  // This file is intentionally copied from the msend lesson as a starting template.
  // Update `stepsConfig` (SmsMphotoLessonSteps.js) later to change the lesson content.
  ...
  // Minimal composer helpers copied from msend lesson
